...
////****  data transformation among nodes-end ****//// 
			...
			X_boundary_condition(myid,U1_,U2_,U3_,U4_,U5_,J);


			Y_boundary_condition(myid,deltaT,heat_flux,U1_,U2_,U3_,U4_,U5_,U1,U2,U3,U4,U5,U1q,U2q,U3q,U4q,U5q,etdy,J);
